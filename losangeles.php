...
$xml_path = __DIR__ . "/xml/losangeles.xml";

$xml = simplexml_load_file($xml_path);

if ($xml === false) {
    die("Errore nel caricamento del file XML di Los Angeles.");
}
...
<head>
    <meta charset="UTF-8">
    <title>Los Angeles - Viaggio</title>
...
<div class="container">
    ...
    <h1>Prenotazione viaggio Los Angeles</h1>
    ...
    <table>
        ...
        <?php if (count($xml->pacchetto_losangeles) > 0): ?>

            <?php foreach ($xml->pacchetto_losangeles as $pacchetto): ?>
