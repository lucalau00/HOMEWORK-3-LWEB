...
// Se l'utente clicca "Aggiungi alla prenotazione"
if (
    ...
    if (
        $destinazione === "" || $categoria === "" || $costo <= 0) 
        {
...
$xml_path = __DIR__ . "/xml/bali.xml";

$xml = simplexml_load_file($xml_path);

if ($xml === false) {
    die("Errore nel caricamento del file XML di Bali.");
}
...
<div class="container">
    ...
    <h1>Prenotazione viaggio Bali</h1>
    ...
    <table>
        ...
        <?php if (count($xml->pacchetto_bali) > 0): ?>

            <?php foreach ($xml->pacchetto_bali as $pacchetto): ?>
